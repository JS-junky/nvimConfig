...
" nnoremap <silent> <A-d> <cmd>lua vim.lsp.buf.signature_help()<CR>
nnoremap <silent> <A-d> <cmd>lua vim.lsp.diagnostic.goto_next()<CR><cmd>lua vim.lsp.diagnostic.goto_prev()<CR>
